...
> **Canonical category prefix:** `16-domain-specific`

Domain-specific skills cover specialised knowledge areas that don't fit neatly into the core agent skill categories — including legal reasoning, medical triage support, financial analysis, and industry-specific workflows.

## Skills in This Category

_No skills added yet. See [CONTRIBUTING.md](../../CONTRIBUTING.md) to add the first one._
